...
ENV __doozer=update BUILD_RELEASE=202406061834.p0.gb45ea65.assembly.test.el9 BUILD_VERSION=v4.17.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=17 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.17.0-202406061834.p0.gb45ea65.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.17 __doozer_key=openshift-base-rhel9 __doozer_version=v4.17.0 
ENV __doozer=merge OS_GIT_COMMIT=b45ea65 OS_GIT_VERSION=4.17.0-202406061834.p0.gb45ea65.assembly.test.el9-b45ea65 SOURCE_DATE_EPOCH=1654869156 SOURCE_GIT_COMMIT=b45ea65bf6606c558b1a18b92ad878f42a411894 SOURCE_GIT_TAG=b45ea65b SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        release="202406061834.p0.gb45ea65.assembly.test.el9" \
